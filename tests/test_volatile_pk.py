...
Validation criteria (Eger 1962, Yasuda 1991):
...
from patient.volatile_pk import VolatilePK, VolatileState
...
class TestVolatilePKWashOut:
    ...
    def test_washout_vrg_fast(self, primed_sevo):
        """VRG should wash out relatively quickly (minutes)."""
...
class TestVolatilePKEdgeCases:
    ...
    def test_age_corrected_mac(self):
        """MAC should decrease with age."""
        patient_young = Patient(age=30, weight=70, height=170, sex="Male")
        patient_old = Patient(age=70, weight=70, height=170, sex="Male")
