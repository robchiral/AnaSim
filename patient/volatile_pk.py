...
class VolatilePK:
    ...
    def __init__(self, patient: Patient, name: str, lambda_b_g: float, lambda_t_b_vrg: float = 1.6, mac_40: float = 2.0):
        ...
        # MAC (Age corrected)
        # Mapleson formula: MAC_age = MAC_40 * 10^(-0.00269 * (age - 40))
        self.mac_40 = mac_40 
    ...
    def step(self, dt: float, fi_agent: float, alveolar_vent_l: float, cardiac_output_l: float, temp_c: float = 37.0):
        ...
        # Equation: dP_tissue/dt = (Q/V) × (1/λ_tissue-blood) × (P_arterial - P_tissue)
        #
        # Derivation:
        ...
        #
        # Reference: Yasuda N et al. Anesthesiology 1991; Mapleson WW. Br J Anaesth 1996 (Physiologically based pharmacokinetic modelling)
