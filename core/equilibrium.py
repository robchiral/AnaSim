...
from patient.pk_models import PropofolPKMarsh, RemifentanilPKMinto, NorepinephrinePK
from patient.pd_models import BISModel, TOLModel
...
class EquilibriumSolver:
    ...
    def solve_bi_objective(
        ...
        if primary_hypnotic == 'propofol':
            ...
            x0 = [0.8, bis_model.params.c50r / 2.0]  # 0.8 MAC default
            bounds = ((0, 3.0), (0, 100))  # MAC 0-3
    ...
    def find_equilibrium(
        ...
        # Step 1: Solve BIS/TOL -> Prop/Remi/MAC
        if fixed_ratio:
            def bis_error(ce_p):
